...
export class Backend implements backendInterface {
    ...
    async getAllDonuts(): Promise<Array<Donut>> {
    ...
    async getDonutById(arg0: bigint): Promise<Donut> {
        if (this.processError) {
            try {
                const result = await this.actor.getDonutById(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getDonutsByCategory(arg0: string): Promise<Array<Donut>> {
        if (this.processError) {
            try {
                const result = await this.actor.getDonutsByCategory(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async searchDonuts(arg0: string): Promise<Array<Donut>> {
        if (this.processError) {
            try {
                const result = await this.actor.searchDonuts(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
